...
export const metadata = { title: "Billed against the list — Sales Dashboard — MahekOne" };
...
export default async function Page({
  ...
  return (
    <div className="p-6">
      ...
      />
      <PricingSubNav basePath="/sales/price-lists" current="variance" />
      <VariancePanel basePath="/sales/price-lists" report={report} monthOptions={months} />
    </div>
  );
}
