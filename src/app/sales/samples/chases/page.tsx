...
import { ChasesScreen, type ChaseRow } from "./chases-screen";

export const metadata = { title: "Review chases — Sales Dashboard — MahekOne" };
...
export default async function Page() {
  ...
  return <ChasesScreen rows={rows} ladder={[...ladder]} today={day} />;
}
