...
import { sectionForPath, type LeadSection } from "./lead-nav";
...
export function LeadTabs({
   ...
   * `/sales/leads/[id]`, which is inside All Leads by path and belongs to no
  ...
  const current = section ?? sectionForPath(pathname);
