...
/**
 * The route guard for the employee master.
 *
 ...
 */
export default async function EmployeesModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "hrms.employees");
  return children;
}
