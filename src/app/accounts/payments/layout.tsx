...
/**
 * The route guard for Payments to confirm.
 *
 ...
 */
export default async function AccountsPaymentsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.payments");
  return children;
}
