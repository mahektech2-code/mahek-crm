...
/**
 * The route guard for the Sheet import.
 *
 ...
 */
export default async function ImportModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.import");
  return children;
}
