 ...
 */
export default async function AccountsBillsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.bills");
  return children;
}
