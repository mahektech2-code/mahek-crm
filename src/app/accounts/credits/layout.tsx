...
/**
 * The route guard for Credit notes.
 *
 ...
 */
export default async function CreditsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.credits");
  return children;
}
