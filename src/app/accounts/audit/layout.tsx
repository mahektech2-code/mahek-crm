...
/**
 * The route guard for the Audit log.
 *
 ...
 */
export default async function AuditModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.audit");
  return children;
}
