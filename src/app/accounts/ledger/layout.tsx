...
/**
 * The route guard for the customer account.
 *
 ...
 */
export default async function LedgerModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.ledger");
  return children;
}
