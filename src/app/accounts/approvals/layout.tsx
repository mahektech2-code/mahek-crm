...
/**
 * The route guard for Order approvals.
 *
 ...
 */
export default async function ApprovalsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.approvals");
  return children;
}
