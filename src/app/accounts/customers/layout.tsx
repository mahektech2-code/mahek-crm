...
/**
 * The route guard for the Accounts customer list.
 *
 ...
 */
export default async function AccountsCustomersModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "accounts.customers");
  return children;
}
