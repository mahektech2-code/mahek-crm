...
/**
 * The route guard for the manager settings.
 *
 ...
 */
export default async function SettingsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.settings");
  return children;
}
