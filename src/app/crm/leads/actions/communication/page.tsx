 ...
 */
import { Body } from "@/components/leads/pages/leads-actions-communication";

export const metadata = { title: "Communication log — CRM — MahekOne" };

export default async function Page(
  props: Omit<React.ComponentProps<typeof Body>, "workspace">,
) {
  return <Body workspace="crm" {...props} />;
}
