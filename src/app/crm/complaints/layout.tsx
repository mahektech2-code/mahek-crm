...
/**
 * The route guard for Complaints.
 *
 ...
 */
export default async function ComplaintsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.complaints");
  return children;
}
