...
/**
 * The route guard for Monthly Targets.
 *
 ...
 */
export default async function TargetsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.targets");
  return children;
}
