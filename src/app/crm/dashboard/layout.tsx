 ...
 */
export default async function DashboardModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.dashboard");
  return children;
}
