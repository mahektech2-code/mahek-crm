...
/**
 * The route guard for the Help Center.
 *
 ...
 */
export default async function HelpModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.help");
  return children;
}
