/* ---------------------------------------------------------------------------
 * BILLED AGAINST THE LIST — the CRM's door onto the variance report.
 *
...
export const metadata = { title: "Billed against the list - MahekOne CRM" };
...
export default async function Page({
  ...
  return (
    <>
      ...
      />
      <PricingSubNav basePath="/crm/price-lists" current="variance" />
      <VariancePanel basePath="/crm/price-lists" report={report} monthOptions={months} />
    </>
  );
}
