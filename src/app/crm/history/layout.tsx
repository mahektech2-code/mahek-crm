...
/**
 * The route guard for Call History.
 *
 ...
 */
export default async function HistoryModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.history");
  return children;
}
