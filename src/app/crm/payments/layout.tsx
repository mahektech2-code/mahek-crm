...
/**
 * The route guard for Payment Follow-up.
 *
 ...
 */
export default async function PaymentsModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.payments");
  return children;
}
