...
/**
 * The route guard for the Inactive Watch.
 *
 ...
 */
export default async function InactiveModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.inactive");
  return children;
}
