...
/**
 * The route guard for the Call Log.
 *
 ...
 */
export default async function CallLogModuleLayout({ children }: { children: React.ReactNode }) {
  const user = await requireUser();
  await requireModule(user.id, "crm.call-log");
  return children;
}
