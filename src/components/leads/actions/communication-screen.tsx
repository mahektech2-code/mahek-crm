  ...
  const chips = [
    {
      key: "all",
      label: "Everybody",
      href: leadHref(workspace, "leads/actions/communication"),
      count: total,
    },
    ...actors.map((a) => ({
      ...
      href: a.actorId
        ? leadHref(workspace, `leads/actions/communication?actor=${encodeURIComponent(a.actorId)}`)
        : leadHref(workspace, "leads/actions/communication"),
      count: a.count,
    })),
  ];
              ...
              <div className="mt-2 flex items-center gap-3 text-[13px]">
                {cursor ? (
                  <Link
                    href={
                      actorId
                        ? leadHref(workspace, `leads/actions/communication?actor=${encodeURIComponent(actorId)}`)
                        : leadHref(workspace, "leads/actions/communication")
                    }
                ...
                {nextCursor ? (
                  <Link
                    href={leadHref(workspace, `leads/actions/communication?${new URLSearchParams({
